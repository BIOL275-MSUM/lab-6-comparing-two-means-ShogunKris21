...
Alternative: At least one of the crab type's body temp is different from the others. 
ANOVA: P vlaue is greater than one the alternative is the correct one and the null is rejected. 